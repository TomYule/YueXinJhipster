...
describe('Service Tests', () => {
  describe('SysDictType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new SysDictType(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 'AAAAAAA', currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a SysDictType', async () => {
      ...
      it('should not update a SysDictType', async () => {
      ...
      it('should not return a list of SysDictType', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a SysDictType', async () => {
