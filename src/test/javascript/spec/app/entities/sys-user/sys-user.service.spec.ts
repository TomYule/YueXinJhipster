...
import { SysUser, UserStatus } from '@/shared/model/sys-user.model';
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            loginDate: format(currentDate, DATE_FORMAT),
      ...
      it('should not create a SysUser', async () => {
      ...
      it('should not update a SysUser', async () => {
      ...
      it('should not return a list of SysUser', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a SysUser', async () => {
